  ...
  return (
    <div className={styles.mentor}>
      <div className={styles.pageHero}>
        <h2>Mentor &amp; Educator</h2>
        <p>Teaching, coaching, and building the next generation of engineers</p>
      </div>

      <div className={styles.content}>
        <header className={styles.headerResume}>
          <h1 className={styles.name}>Clark Jason Ngo</h1>
          <p className={styles.headline}>Educator | Senior AI Engineer | Mentor</p>
        ...
        <section className={styles.section}>
          ...
          <article className={styles.job}>
            ...
            <ul>
              <li>Built "AI Hub" — a portfolio of AI apps translating complex concepts into approachable modules for learners.</li>
        ...
        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>Athletic Coaching</h2>
          <article className={styles.job}>
            <h3>Leveraging sports to teach discipline, resilience, and teamwork</h3>
            <div className={styles.meta}>2021 – Present</div>
            <ul>
